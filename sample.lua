...
frame:SetScript("OnShow", function(self)
	...
	for i,font in pairs(fonts) do
		local fs if type(_G[font]) == "table" and _G[font].GetFont then
			fs = frame:CreateFontString(nil, "ARTWORK", font)
		else
...
local category = Settings.RegisterCanvasLayoutCategory(frame, "Tekticles")
